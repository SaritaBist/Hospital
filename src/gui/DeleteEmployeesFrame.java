...
public class DeleteEmployeesFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Delete Employee Panel");
    ...
    private void jcEmpIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcEmpIdActionPerformed
         try{
            EmployeePojo empPojoList = EmployeeDAO.getEmpById(jcEmpId.getSelectedItem().toString());
            txtEmpName.setText(empPojoList.getEpname());
            jcJob.setSelectedItem(empPojoList.getJob());
            txtSalary.setText(String.valueOf(empPojoList.getSalary()));
    ...
    private void getAllEmpID() {
     try
       {
           List<String> getEmpId = EmployeeDAO.getAllEmpId();
           for(String EmpList : getEmpId){
               jcEmpId.addItem(EmpList);
           }
